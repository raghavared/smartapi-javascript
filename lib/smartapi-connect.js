...
var SmartApi = function (params) {
     ...
     * @param {string} qParam
     */
    self.indOrderDetails = function (qParam) {
        return get_request("ind_order_details",undefined, undefined, undefined, qParam);
    };
	...
	function get_request(route, params, responseType, responseTransformer, qParam) {
		return request_util(
			route,
			'GET',
			params || {},
